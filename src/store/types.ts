...
export const SET_LISTID_TO_DELETE ='SET_LIST_IS_TO_DELETE';
...
//Actions
 ...
 SetListToEditAction | DeleteListAction | UpdateListAction
 | SetSelectedListAction | AddTaskAction | DeleteTaskAction
